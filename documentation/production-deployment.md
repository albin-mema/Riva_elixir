...
This guide covers deploying Riva Ash to production with proper security, monitoring, and scalability considerations.
...
```bash
# Database
DATABASE_URL=postgresql://riva_user:secure_password@db:5432/riva_ash_prod
DB_USERNAME=riva_user
...
- **Readiness**: `GET /health/readiness` - Ready to serve traffic (includes DB check)
