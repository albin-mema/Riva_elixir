defmodule RivaAsh.Resources.RecurringReservationInstance do
  ...
  code_interface do
    ...
    define :by_recurring_reservation, args: [:recurring_reservation_id], action: :by_recurring_reservation
  ...
  actions do
    ...
    create :create do
      accept [
        :recurring_reservation_id, :scheduled_date, :sequence_number,
        :status, :notes, :skip_reason
      ]
      primary? true
    end
    ...
    # TODO: Add action to create the actual reservation for this instance
    # action :create_reservation, :struct do
    #   constraints instance_of: RivaAsh.Resources.RecurringReservationInstance
    #   argument :id, :uuid, allow_nil?: false
    #   run RivaAsh.Reactors.RecurringInstanceReservationCreator
    # end
  end
  ...
  calculations do
    ...
    calculate :days_until_scheduled, :integer,
