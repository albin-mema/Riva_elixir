defmodule RivaAshWeb.Components.UIWrapped.Badge do
  @moduledoc """
  App-level Badge wrapper around SaladUI.Badge.
  ...
  @doc """
  Renders a SaladUI-backed badge with app-level props.
  """
  attr :variant, :string,
    default: "default",
  ...
  defp map_variant(v) when v in ["default", "secondary", "destructive", "outline", "success", "warning"], do: v
