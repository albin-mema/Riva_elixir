  ...
  def reservation_booking_form(assigns) do
    ...
    <div {@rest}>
      ...
      <form phx-submit={@on_submit} phx-change={@on_change}>
        ...
        <div :if={@step == 1}>
          <h3>Select Client</h3>
          <.form_field field={@form[:client_id]} label="Client" type="select" options={@clients} required />
        ...
        <div :if={@step == 2}>
          <h3>Select Item</h3>
          <.form_field field={@form[:item_id]} label="Item" type="select" options={@items} required />
        ...
        <div :if={@step == 3}>
          ...
          <.date_picker field={@form[:reservation_date]} label="Date" required />
        ...
        <div :if={@step == 4}>
          ...
          <.form_field field={@form[:payment_method]} label="Payment Method" type="select" options={[
            {"Cash", "cash"},
