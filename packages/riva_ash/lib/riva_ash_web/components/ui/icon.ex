defmodule RivaAshWeb.Components.UI.Icon do
  ...
  defp render_icon_path(name) do
    case name do
      ...
      :ellipsis_vertical ->
        Phoenix.HTML.raw(
          ~s(<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 5v.01M12 12v.01M12 19v.01" />)
        )
      ...
      :chevron_up ->
        Phoenix.HTML.raw(
          ~s(<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 15l-7-7-7 7" />)
        )

      :chevron_down ->
        Phoenix.HTML.raw(
          ~s(<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 9l7 7 7-7" />)
        )

      :clock ->
        Phoenix.HTML.raw(
          ~s(<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />)
        )
      ...
      :circle ->
        Phoenix.HTML.raw(
          ~s(<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />)
        )
