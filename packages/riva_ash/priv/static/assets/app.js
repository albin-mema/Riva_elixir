...
`);
  ...
  document.addEventListener("DOMContentLoaded", () => {
    const rootElements = document.querySelectorAll("[data-react-root]");
    rootElements.forEach((element) => {
      const root = ReactDOM.createRoot(element);
      root.render(React.createElement(window[element.dataset.component], JSON.parse(element.dataset.props)));
    });
  });
