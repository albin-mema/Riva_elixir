defmodule RivaAsh.PaperTrailArchivalTest do
  ...
  @doc """
  Tests that archiving a business creates a version record.
  """
  @spec test_archiving_business_creates_version_record :: :ok
  ...
  @doc """
  Tests that paper trail tracks all changes before archival.
  """
  @spec test_paper_trail_tracks_all_changes_before_archival :: :ok
  ...
  @doc """
  Tests that paper trail works with client archival.
  """
  @spec test_paper_trail_works_with_client_archival :: :ok
  ...
  @doc """
  Tests that paper trail works with permission archival.
  """
  @spec test_paper_trail_works_with_permission_archival :: :ok
  ...
  @doc """
  Tests that version records contain proper metadata.
  """
  @spec test_version_records_contain_proper_metadata :: :ok
