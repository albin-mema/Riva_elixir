defmodule WorkingBrowserTest do
  ...
  test "open browser and show automation" do
    ...
    Process.sleep(3000)  # Wait for server to start
    
    # Open browser manually first so you can see it
    {_output, _exit_code} = System.cmd("chromium", [
      "--new-window",
      "--no-first-run",
    ...
    Process.sleep(2000)  # Let browser open
    ...
    try do
      ...
      error ->
        ...
        Process.sleep(10000)  # Keep browser open for 10 seconds
    end
  end
end
